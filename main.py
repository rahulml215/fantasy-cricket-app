...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.a = []  # bowler names 
        self.b = []  # batsman names
        self.c = []  # allrounder names 
        self.d = []  # wicketer names
        self.list1 = []  # selectedplayer's 
        ...
        self.centralwidget.setObjectName("Helvetica")
